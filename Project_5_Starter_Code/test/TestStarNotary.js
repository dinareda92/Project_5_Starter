...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(await instance.getName(),"StarNotary Token");
...
it('lets 2 users exchange stars', async() => {
    ...
    let star1Id = 6;
    let star2Id = 7;
    await instance.createStar('first star', star1Id, {from: user1});
    await instance.createStar('second star', star2Id, {from: user2});
...
it('lets a user transfer a star', async() => {
    ...
    await instance.createStar('new star', star1Id, {from: user1});
    // 2. use the transferStar function implemented in the Smart Contract
    assert.equal(await instance.ownerOf(star1Id), user1)

    await instance.transferStar(user2,star1Id,{from:owner})
